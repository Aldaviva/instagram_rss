...
public class ApiExceptionMapperTest {
    ...
    public void noSuchUser(){
        Response response = apiExceptionMapper.toResponse(new InstagramException.NoSuchUser("username", "message", null));
    ...
    public void privateProfile(){
        Response response = apiExceptionMapper.toResponse(new InstagramException.PrivateProfile("username", "message"));
    ...
    public void instagramException(){
        Response response = apiExceptionMapper.toResponse(new InstagramException("message"));
